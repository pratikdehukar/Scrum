...
public class Impediment {
	...
	public long getImpedimentId() {
		return impedimentId;
	}

	public void setImpedimentId(long impedimentId) {
	...
	public Impediment(long impedimentId, String title, String description, String priority,
			IssueImpedimentStatus statusId, Date date, ProjectUserRole raisedBy, ProjectUserRole assignedTo,
			ReleaseSprint releaseSprintId) {
		super();
		this.impedimentId = impedimentId;
		this.title = title;
		this.description = description;
